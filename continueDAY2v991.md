...
The diagram below [^1] illustrates the logic behind branching in GitHub/Git. In this particular example the sequence we followed is main --> development --> feature. The latter  constitutes the actual working space.

![slide 54 from GJB's training material "version_control_git.pptx"](slide54.png)
